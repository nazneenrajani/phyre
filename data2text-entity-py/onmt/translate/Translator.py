...
class Translator(object):
    ...
    def translate_batch(self, batch, data):
        ...
        enc_states, memory_bank, entity_embeddings = self.model.encoder(src, src_lengths,
                                                                        entities_list=batch.entities_list,
                                                                        entities_len=batch.entities_len)
        dec_states = self.model.decoder.init_decoder_state(
            src, memory_bank, enc_states, entity_embeddings)
        ...
        entity_embeddings = rvar(entity_embeddings.data)
        ...
        for i in range(self.max_length):
            ...
            # Run one step.
            dec_out, dec_states, attn = self.model.decoder(inp, memory_bank, entity_embeddings, dec_states,
