...
def model_opts(parser):
    ...
    group.add_argument('-entity_memory_size', type=int, default=300,
                       help='Size of entity memory states')
...
def train_opts(parser):
    ...
    group.add_argument('-override_vocab_path', default="",
                       help="path if overriding vocab")
    group.add_argument('-load_checkpoint_optim', default=1, type=int,
                        help="should we load optimizer from checkpoint?")
